...
\begin{equation}
  \label{eq:bartlett}
  r_k(\Sigma) = \frac{\sum_{i>k}\lambda_i}{\lambda_{k+1}}, \quad
...
\paragraph{Neural tangent kernel.} \citet{jacot2018neural} prove that in the infinite-width limit $f(x;\theta)$ at small training time is well-approximated by its first-order Taylor expansion around the random initialisation $\theta_0$:
\begin{equation}
  \label{eq:ntk}
...
\begin{figure*}[t]
  ...
  \begin{subfigure}{0.48\textwidth}
    \includegraphics[width=\linewidth,keepaspectratio]{fig1_model_wise_rff.png}
    \caption{Model-wise: test MSE vs.\ $p/n$ for fixed $n=1{,}000$, three noise rates.}
  \end{subfigure}\hfill
  \begin{subfigure}{0.48\textwidth}
    \includegraphics[width=\linewidth,keepaspectratio]{fig3_sample_wise_rff.png}
...
\paragraph{Mechanism: variance explosion.} The min-norm interpolant is $\hat{w} = \Phi^\top(\Phi\Phi^\top + \lambda I)^{-1}y$. Decomposing the test risk as $\mathbb{E}[(\hat f(x_*) - f^*(x_*))^2] = \mathrm{Bias}^2(p) + \mathrm{Var}(p) + \sigma^2$, the variance term in the ridgeless limit can be written
\begin{equation}
  \label{eq:variance}
  \mathrm{Var}(p) = \sigma^2 \cdot \mathrm{tr}\big(\Phi\Phi^\top(\Phi\Phi^\top+\lambda I)^{-2}\Phi\Phi^\top\big) \xrightarrow{\,\lambda\to0^+\,} \sigma^2 \!\sum_{i:\sigma_i>0}\!\sigma_i^{-2},
\end{equation}
...
\begin{figure*}[t]
  ...
  \begin{subfigure}{0.32\textwidth}
    \includegraphics[width=\linewidth,keepaspectratio]{personA_ridge_smooths_peak.png}
    \caption{Person A: ridge sweep.}
  \end{subfigure}\hfill
  \begin{subfigure}{0.32\textwidth}
    \includegraphics[width=\linewidth,keepaspectratio]{personB_noise_amplification.png}
    \caption{Person B: noise sweep.}
  \end{subfigure}\hfill
  \begin{subfigure}{0.32\textwidth}
    \includegraphics[width=\linewidth,keepaspectratio]{bias_variance.png}
...
\begin{figure*}[t]
  ...
  \begin{subfigure}{0.49\textwidth}
    \includegraphics[width=\linewidth,keepaspectratio]{fig1_main_valley_metric_audit.png}
  ...
  \end{subfigure}\hfill
  \begin{subfigure}{0.49\textwidth}
    \includegraphics[width=\linewidth,keepaspectratio]{resnet18_vs_fractionalk.png}
...
\begin{figure*}[t]
  \centering
  \begin{subfigure}{0.49\textwidth}
    \includegraphics[width=\linewidth,keepaspectratio]{nn_effective_rank_vs_k.png}
    \caption{Penultimate-feature normalised stable rank and condition number vs.\ $k$.}
  \end{subfigure}\hfill
  \begin{subfigure}{0.49\textwidth}
    \includegraphics[width=\linewidth,keepaspectratio]{fig3_bartlett_vacuity.png}
...
\begin{figure*}[t]
  \centering
  \begin{subfigure}{0.49\textwidth}
    \includegraphics[width=\linewidth,keepaspectratio]{full_empirical_ntk_quick.png}
    \caption{Full empirical NTK Gram diagnostics vs.\ $k$ ($n\!=\!1{,}000$, 200 epochs, $N\!=\!12$).}
  \end{subfigure}\hfill
  \begin{subfigure}{0.49\textwidth}
    \includegraphics[width=\linewidth,keepaspectratio]{hessian_topeig_vs_k.png}
...
\begin{figure*}[t]
  \centering
  \begin{subfigure}{0.49\textwidth}
    \includegraphics[width=\linewidth,keepaspectratio]{samplewise_nn_dd.png}
    \caption{Sample-wise sweep: test error vs.\ $k$ at four $n$.}
  \end{subfigure}\hfill
  \begin{subfigure}{0.49\textwidth}
    \includegraphics[width=\linewidth,keepaspectratio]{fig2_sample_wise_second_descent.png}
...
\begin{figure*}[t]
  \centering
  \begin{subfigure}{0.49\textwidth}
    \includegraphics[width=\linewidth,keepaspectratio]{personC_optimizer_modelwise.png}
    \caption{Model-wise.}
  \end{subfigure}\hfill
  \begin{subfigure}{0.49\textwidth}
    \includegraphics[width=\linewidth,keepaspectratio]{personC_optimizer_epochwise.png}
    \caption{Epoch-wise.}
  \end{subfigure}
...
\begin{figure}[t]
  \centering
  \includegraphics[width=0.85\linewidth,keepaspectratio]{personD_bound_vs_observed.png}
...
\begin{table}[t]
  \centering
  \small
  \caption{Test accuracy at the DD-recovery onset $k\!=\!0.1875$ across three activations. GELU recovers and \emph{beats} ReLU by $+1.7$\,pp; Tanh under-performs by roughly two points.}
...
\begin{table*}[t]
  \centering
  \small
  \caption{Best test accuracy at $k\!=\!0.5$ across three depths. The DD-recovery shape is preserved at all three depths; lean depth wins on noisy data.}
...
\begin{figure*}[t]
  \centering
  \begin{subfigure}{0.49\textwidth}
    \includegraphics[width=\linewidth,keepaspectratio]{fractionalk_epochwise.png}
    \caption{Epoch-wise dynamics: test accuracy vs.\ epoch.}
  \end{subfigure}\hfill
  \begin{subfigure}{0.49\textwidth}
    \includegraphics[width=\linewidth,keepaspectratio]{fractionalk_epochwise_spectral.png}
...
\paragraph{Code.} Repository \url{https://github.com/shufengc/double-descent-deep-learning}. Entry points: \texttt{src/experiments/comprehensive\_dd.py} for RFF Exps 1--2, \texttt{src/experiments/exp\_dd\_recovery.py} for the fractional-$k$ campaign, \texttt{src/experiments/exp\_samplewise\_nn.py} for \cref{sec:samplewise}, and the four \texttt{src/experiments/person\{A,B,C,D\}\_*.py} scripts for \cref{sec:rff} and \cref{app:optimizer}.
